...
class XNXX : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        ...
        "$mainUrl/search/18+year+old?top" to "18 Year Old",
        ...
        "$mainUrl/search/cum-on-face" to "Cum on Face",
        "$mainUrl/search/cum-swallowing" to "Cum Swallowing",
        "$mainUrl/search/cum-in-pussy" to "Cum in Pussy",
        "$mainUrl/search/cum-on-pussy" to "Cum on Pussy",
        "$mainUrl/search/cuminmouth" to "CuminMouth",
        "$mainUrl/search/cum-on-tits" to "Cum on Tits",
        "$mainUrl/search/outdoor?top" to "Outdoor",
        "$mainUrl/search/cougar?top" to "Cougar"
    )
